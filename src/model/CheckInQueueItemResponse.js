...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CherwellRestApi.CheckInQueueItemResponse = factory(root.CherwellRestApi.ApiClient);
  }
  ...
  /**
   * The CheckInQueueItemResponse model module.
   * @module model/CheckInQueueItemResponse
   * @version 9.2.0
   */

  /**
   * Constructs a new <code>CheckInQueueItemResponse</code>.
   * @alias module:model/CheckInQueueItemResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>CheckInQueueItemResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CheckInQueueItemResponse} obj Optional instance to populate.
   * @return {module:model/CheckInQueueItemResponse} The populated <code>CheckInQueueItemResponse</code> instance.
   */
