...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CherwellRestApi.AddItemToQueueResponse = factory(root.CherwellRestApi.ApiClient);
  }
  ...
  /**
   * The AddItemToQueueResponse model module.
   * @module model/AddItemToQueueResponse
   * @version 9.2.0
   */

  /**
   * Constructs a new <code>AddItemToQueueResponse</code>.
   * @alias module:model/AddItemToQueueResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>AddItemToQueueResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AddItemToQueueResponse} obj Optional instance to populate.
   * @return {module:model/AddItemToQueueResponse} The populated <code>AddItemToQueueResponse</code> instance.
   */
