...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CherwellRestApi.SaveUrlAttachmentRequest = factory(root.CherwellRestApi.ApiClient);
  }
  ...
  /**
   * The SaveUrlAttachmentRequest model module.
   * @module model/SaveUrlAttachmentRequest
   * @version 9.2.0
   */

  /**
   * Constructs a new <code>SaveUrlAttachmentRequest</code>.
   * @alias module:model/SaveUrlAttachmentRequest
   * @class
   */
  ...
  /**
   * Constructs a <code>SaveUrlAttachmentRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SaveUrlAttachmentRequest} obj Optional instance to populate.
   * @return {module:model/SaveUrlAttachmentRequest} The populated <code>SaveUrlAttachmentRequest</code> instance.
   */
