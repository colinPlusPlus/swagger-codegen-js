...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CherwellRestApi.SaveLinkAttachmentRequest = factory(root.CherwellRestApi.ApiClient);
  }
  ...
  /**
   * The SaveLinkAttachmentRequest model module.
   * @module model/SaveLinkAttachmentRequest
   * @version 9.2.0
   */

  /**
   * Constructs a new <code>SaveLinkAttachmentRequest</code>.
   * @alias module:model/SaveLinkAttachmentRequest
   * @class
   */
  ...
  /**
   * Constructs a <code>SaveLinkAttachmentRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SaveLinkAttachmentRequest} obj Optional instance to populate.
   * @return {module:model/SaveLinkAttachmentRequest} The populated <code>SaveLinkAttachmentRequest</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('uncFilePath')) {
        obj['uncFilePath'] = ApiClient.convertToType(data['uncFilePath'], 'String');
      }
    }
    return obj;
  }
  ...
  /**
   * @member {String} uncFilePath
   */
  exports.prototype['uncFilePath'] = undefined;
