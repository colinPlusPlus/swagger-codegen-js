...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CherwellRestApi.RemoveItemFromQueueResponse = factory(root.CherwellRestApi.ApiClient);
  }
  ...
  /**
   * The RemoveItemFromQueueResponse model module.
   * @module model/RemoveItemFromQueueResponse
   * @version 9.2.0
   */

  /**
   * Constructs a new <code>RemoveItemFromQueueResponse</code>.
   * @alias module:model/RemoveItemFromQueueResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>RemoveItemFromQueueResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RemoveItemFromQueueResponse} obj Optional instance to populate.
   * @return {module:model/RemoveItemFromQueueResponse} The populated <code>RemoveItemFromQueueResponse</code> instance.
   */
