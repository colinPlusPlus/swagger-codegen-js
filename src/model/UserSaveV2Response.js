...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CherwellRestApi.UserSaveV2Response = factory(root.CherwellRestApi.ApiClient);
  }
  ...
  /**
   * The UserSaveV2Response model module.
   * @module model/UserSaveV2Response
   * @version 9.2.0
   */

  /**
   * Constructs a new <code>UserSaveV2Response</code>.
   * @alias module:model/UserSaveV2Response
   * @class
   */
  ...
  /**
   * Constructs a <code>UserSaveV2Response</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UserSaveV2Response} obj Optional instance to populate.
   * @return {module:model/UserSaveV2Response} The populated <code>UserSaveV2Response</code> instance.
   */
