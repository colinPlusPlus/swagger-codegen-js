...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.TeamResponse();
  });
  ...
  describe('TeamResponse', function() {
    it('should create an instance of TeamResponse', function() {
      // uncomment below and update the code to test TeamResponse
      //var instance = new CherwellRestApi.TeamResponse();
      //expect(instance).to.be.a(CherwellRestApi.TeamResponse);
    });
