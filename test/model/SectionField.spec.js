...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.SectionField();
  });
  ...
  describe('SectionField', function() {
    it('should create an instance of SectionField', function() {
      // uncomment below and update the code to test SectionField
      //var instance = new CherwellRestApi.SectionField();
      //expect(instance).to.be.a(CherwellRestApi.SectionField);
    });
