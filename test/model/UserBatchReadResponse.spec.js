...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.UserBatchReadResponse();
  });
  ...
  describe('UserBatchReadResponse', function() {
    it('should create an instance of UserBatchReadResponse', function() {
      // uncomment below and update the code to test UserBatchReadResponse
      //var instance = new CherwellRestApi.UserBatchReadResponse();
      //expect(instance).to.be.a(CherwellRestApi.UserBatchReadResponse);
    });
