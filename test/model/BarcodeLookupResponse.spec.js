...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.BarcodeLookupResponse();
  });
  ...
  describe('BarcodeLookupResponse', function() {
    it('should create an instance of BarcodeLookupResponse', function() {
      // uncomment below and update the code to test BarcodeLookupResponse
      //var instance = new CherwellRestApi.BarcodeLookupResponse();
      //expect(instance).to.be.a(CherwellRestApi.BarcodeLookupResponse);
    });
