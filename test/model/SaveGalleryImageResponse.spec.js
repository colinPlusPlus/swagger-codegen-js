...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.SaveGalleryImageResponse();
  });
  ...
  describe('SaveGalleryImageResponse', function() {
    it('should create an instance of SaveGalleryImageResponse', function() {
      // uncomment below and update the code to test SaveGalleryImageResponse
      //var instance = new CherwellRestApi.SaveGalleryImageResponse();
      //expect(instance).to.be.a(CherwellRestApi.SaveGalleryImageResponse);
    });
