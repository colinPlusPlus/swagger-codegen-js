...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.UserDeleteResponse();
  });
  ...
  describe('UserDeleteResponse', function() {
    it('should create an instance of UserDeleteResponse', function() {
      ...
      //var instance = new CherwellRestApi.UserDeleteResponse();
      //expect(instance).to.be.a(CherwellRestApi.UserDeleteResponse);
    });
