...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.ManagerData();
  });
  ...
  describe('ManagerData', function() {
    it('should create an instance of ManagerData', function() {
      // uncomment below and update the code to test ManagerData
      //var instance = new CherwellRestApi.ManagerData();
      //expect(instance).to.be.a(CherwellRestApi.ManagerData);
    });
