...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.FilterInfo();
  });
  ...
  describe('FilterInfo', function() {
    it('should create an instance of FilterInfo', function() {
      // uncomment below and update the code to test FilterInfo
      //var instance = new CherwellRestApi.FilterInfo();
      //expect(instance).to.be.a(CherwellRestApi.FilterInfo);
    });
