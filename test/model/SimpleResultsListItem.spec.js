...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.SimpleResultsListItem();
  });
  ...
  describe('SimpleResultsListItem', function() {
    it('should create an instance of SimpleResultsListItem', function() {
      // uncomment below and update the code to test SimpleResultsListItem
      //var instance = new CherwellRestApi.SimpleResultsListItem();
      //expect(instance).to.be.a(CherwellRestApi.SimpleResultsListItem);
    });
    ...
    it('should have the property docRepositoryItemId (base name: "docRepositoryItemId")', function() {
      // uncomment below and update the code to test the property docRepositoryItemId
      //var instance = new CherwellRestApi.SimpleResultsListItem();
      //expect(instance).to.be();
    });
