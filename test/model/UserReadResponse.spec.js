...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.UserReadResponse();
  });
  ...
  describe('UserReadResponse', function() {
    it('should create an instance of UserReadResponse', function() {
      // uncomment below and update the code to test UserReadResponse
      //var instance = new CherwellRestApi.UserReadResponse();
      //expect(instance).to.be.a(CherwellRestApi.UserReadResponse);
    });
