...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.RelatedSaveResponse();
  });
  ...
  describe('RelatedSaveResponse', function() {
    it('should create an instance of RelatedSaveResponse', function() {
      // uncomment below and update the code to test RelatedSaveResponse
      //var instance = new CherwellRestApi.RelatedSaveResponse();
      //expect(instance).to.be.a(CherwellRestApi.RelatedSaveResponse);
    });
