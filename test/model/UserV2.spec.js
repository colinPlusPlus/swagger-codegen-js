...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.UserV2();
  });
  ...
  describe('UserV2', function() {
    it('should create an instance of UserV2', function() {
      // uncomment below and update the code to test UserV2
      //var instance = new CherwellRestApi.UserV2();
      //expect(instance).to.be.a(CherwellRestApi.UserV2);
    });
