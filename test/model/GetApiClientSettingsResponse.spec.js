...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.GetApiClientSettingsResponse();
  });
  ...
  describe('GetApiClientSettingsResponse', function() {
    it('should create an instance of GetApiClientSettingsResponse', function() {
      // uncomment below and update the code to test GetApiClientSettingsResponse
      //var instance = new CherwellRestApi.GetApiClientSettingsResponse();
      //expect(instance).to.be.a(CherwellRestApi.GetApiClientSettingsResponse);
    });
