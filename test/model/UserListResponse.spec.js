...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.UserListResponse();
  });
  ...
  describe('UserListResponse', function() {
    it('should create an instance of UserListResponse', function() {
      // uncomment below and update the code to test UserListResponse
      //var instance = new CherwellRestApi.UserListResponse();
      //expect(instance).to.be.a(CherwellRestApi.UserListResponse);
    });
