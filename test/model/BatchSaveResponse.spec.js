...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.BatchSaveResponse();
  });
  ...
  describe('BatchSaveResponse', function() {
    it('should create an instance of BatchSaveResponse', function() {
      // uncomment below and update the code to test BatchSaveResponse
      //var instance = new CherwellRestApi.BatchSaveResponse();
      //expect(instance).to.be.a(CherwellRestApi.BatchSaveResponse);
    });
