...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.CheckInQueueItemResponse();
  });
  ...
  describe('CheckInQueueItemResponse', function() {
    it('should create an instance of CheckInQueueItemResponse', function() {
      // uncomment below and update the code to test CheckInQueueItemResponse
      //var instance = new CherwellRestApi.CheckInQueueItemResponse();
      //expect(instance).to.be.a(CherwellRestApi.CheckInQueueItemResponse);
    });
