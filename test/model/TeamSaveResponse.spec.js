...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.TeamSaveResponse();
  });
  ...
  describe('TeamSaveResponse', function() {
    it('should create an instance of TeamSaveResponse', function() {
      // uncomment below and update the code to test TeamSaveResponse
      //var instance = new CherwellRestApi.TeamSaveResponse();
      //expect(instance).to.be.a(CherwellRestApi.TeamSaveResponse);
    });
