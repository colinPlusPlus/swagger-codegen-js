...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.UserReadRequest();
  });
  ...
  describe('UserReadRequest', function() {
    it('should create an instance of UserReadRequest', function() {
      // uncomment below and update the code to test UserReadRequest
      //var instance = new CherwellRestApi.UserReadRequest();
      //expect(instance).to.be.a(CherwellRestApi.UserReadRequest);
    });
