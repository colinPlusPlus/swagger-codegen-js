...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.RoleReadResponse();
  });
  ...
  describe('RoleReadResponse', function() {
    it('should create an instance of RoleReadResponse', function() {
      // uncomment below and update the code to test RoleReadResponse
      //var instance = new CherwellRestApi.RoleReadResponse();
      //expect(instance).to.be.a(CherwellRestApi.RoleReadResponse);
    });
