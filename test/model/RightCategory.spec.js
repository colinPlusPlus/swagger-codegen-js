...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.RightCategory();
  });
  ...
  describe('RightCategory', function() {
    it('should create an instance of RightCategory', function() {
      // uncomment below and update the code to test RightCategory
      //var instance = new CherwellRestApi.RightCategory();
      //expect(instance).to.be.a(CherwellRestApi.RightCategory);
    });
