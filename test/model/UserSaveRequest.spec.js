...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.UserSaveRequest();
  });
  ...
  describe('UserSaveRequest', function() {
    it('should create an instance of UserSaveRequest', function() {
      // uncomment below and update the code to test UserSaveRequest
      //var instance = new CherwellRestApi.UserSaveRequest();
      //expect(instance).to.be.a(CherwellRestApi.UserSaveRequest);
    });
