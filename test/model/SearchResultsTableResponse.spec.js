...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.SearchResultsTableResponse();
  });
  ...
  describe('SearchResultsTableResponse', function() {
    it('should create an instance of SearchResultsTableResponse', function() {
      // uncomment below and update the code to test SearchResultsTableResponse
      //var instance = new CherwellRestApi.SearchResultsTableResponse();
      //expect(instance).to.be.a(CherwellRestApi.SearchResultsTableResponse);
    });
