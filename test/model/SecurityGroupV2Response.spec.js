...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.SecurityGroupV2Response();
  });
  ...
  describe('SecurityGroupV2Response', function() {
    it('should create an instance of SecurityGroupV2Response', function() {
      // uncomment below and update the code to test SecurityGroupV2Response
      //var instance = new CherwellRestApi.SecurityGroupV2Response();
      //expect(instance).to.be.a(CherwellRestApi.SecurityGroupV2Response);
    });
