...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.SecurityRightsResponse();
  });
  ...
  describe('SecurityRightsResponse', function() {
    it('should create an instance of SecurityRightsResponse', function() {
      // uncomment below and update the code to test SecurityRightsResponse
      //var instance = new CherwellRestApi.SecurityRightsResponse();
      //expect(instance).to.be.a(CherwellRestApi.SecurityRightsResponse);
    });
