...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.SaveRequest();
  });
  ...
  describe('SaveRequest', function() {
    it('should create an instance of SaveRequest', function() {
      // uncomment below and update the code to test SaveRequest
      //var instance = new CherwellRestApi.SaveRequest();
      //expect(instance).to.be.a(CherwellRestApi.SaveRequest);
    });
