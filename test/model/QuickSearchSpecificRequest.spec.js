...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.QuickSearchSpecificRequest();
  });
  ...
  describe('QuickSearchSpecificRequest', function() {
    it('should create an instance of QuickSearchSpecificRequest', function() {
      // uncomment below and update the code to test QuickSearchSpecificRequest
      //var instance = new CherwellRestApi.QuickSearchSpecificRequest();
      //expect(instance).to.be.a(CherwellRestApi.QuickSearchSpecificRequest);
    });
