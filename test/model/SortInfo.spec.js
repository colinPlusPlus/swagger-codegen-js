...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.SortInfo();
  });
  ...
  describe('SortInfo', function() {
    it('should create an instance of SortInfo', function() {
      // uncomment below and update the code to test SortInfo
      //var instance = new CherwellRestApi.SortInfo();
      //expect(instance).to.be.a(CherwellRestApi.SortInfo);
    });
