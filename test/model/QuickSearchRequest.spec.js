...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.QuickSearchRequest();
  });
  ...
  describe('QuickSearchRequest', function() {
    it('should create an instance of QuickSearchRequest', function() {
      // uncomment below and update the code to test QuickSearchRequest
      //var instance = new CherwellRestApi.QuickSearchRequest();
      //expect(instance).to.be.a(CherwellRestApi.QuickSearchRequest);
    });
