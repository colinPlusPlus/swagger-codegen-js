...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.CheckOutQueueItemResponse();
  });
  ...
  describe('CheckOutQueueItemResponse', function() {
    it('should create an instance of CheckOutQueueItemResponse', function() {
      // uncomment below and update the code to test CheckOutQueueItemResponse
      //var instance = new CherwellRestApi.CheckOutQueueItemResponse();
      //expect(instance).to.be.a(CherwellRestApi.CheckOutQueueItemResponse);
    });
