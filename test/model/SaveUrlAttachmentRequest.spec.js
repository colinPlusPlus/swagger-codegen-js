...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.SaveUrlAttachmentRequest();
  });
  ...
  describe('SaveUrlAttachmentRequest', function() {
    it('should create an instance of SaveUrlAttachmentRequest', function() {
      // uncomment below and update the code to test SaveUrlAttachmentRequest
      //var instance = new CherwellRestApi.SaveUrlAttachmentRequest();
      //expect(instance).to.be.a(CherwellRestApi.SaveUrlAttachmentRequest);
    });
