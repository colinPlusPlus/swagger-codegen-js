...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.SaveTeamMemberResponse();
  });
  ...
  describe('SaveTeamMemberResponse', function() {
    it('should create an instance of SaveTeamMemberResponse', function() {
      // uncomment below and update the code to test SaveTeamMemberResponse
      //var instance = new CherwellRestApi.SaveTeamMemberResponse();
      //expect(instance).to.be.a(CherwellRestApi.SaveTeamMemberResponse);
    });
