...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.TemplateResponse();
  });
  ...
  describe('TemplateResponse', function() {
    it('should create an instance of TemplateResponse', function() {
      ...
      //var instance = new CherwellRestApi.TemplateResponse();
      //expect(instance).to.be.a(CherwellRestApi.TemplateResponse);
    });
