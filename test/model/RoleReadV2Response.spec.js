...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.RoleReadV2Response();
  });
  ...
  describe('RoleReadV2Response', function() {
    it('should create an instance of RoleReadV2Response', function() {
      // uncomment below and update the code to test RoleReadV2Response
      //var instance = new CherwellRestApi.RoleReadV2Response();
      //expect(instance).to.be.a(CherwellRestApi.RoleReadV2Response);
    });
