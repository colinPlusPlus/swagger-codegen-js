...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.SimpleResultsList();
  });
  ...
  describe('SimpleResultsList', function() {
    it('should create an instance of SimpleResultsList', function() {
      // uncomment below and update the code to test SimpleResultsList
      //var instance = new CherwellRestApi.SimpleResultsList();
      //expect(instance).to.be.a(CherwellRestApi.SimpleResultsList);
    });
