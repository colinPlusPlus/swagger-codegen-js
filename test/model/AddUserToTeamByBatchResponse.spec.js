...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.AddUserToTeamByBatchResponse();
  });
  ...
  describe('AddUserToTeamByBatchResponse', function() {
    it('should create an instance of AddUserToTeamByBatchResponse', function() {
      // uncomment below and update the code to test AddUserToTeamByBatchResponse
      //var instance = new CherwellRestApi.AddUserToTeamByBatchResponse();
      //expect(instance).to.be.a(CherwellRestApi.AddUserToTeamByBatchResponse);
    });
