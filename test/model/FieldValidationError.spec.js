...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.FieldValidationError();
  });
  ...
  describe('FieldValidationError', function() {
    it('should create an instance of FieldValidationError', function() {
      // uncomment below and update the code to test FieldValidationError
      //var instance = new CherwellRestApi.FieldValidationError();
      //expect(instance).to.be.a(CherwellRestApi.FieldValidationError);
    });
