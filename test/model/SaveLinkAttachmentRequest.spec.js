...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.SaveLinkAttachmentRequest();
  });
  ...
  describe('SaveLinkAttachmentRequest', function() {
    it('should create an instance of SaveLinkAttachmentRequest', function() {
      // uncomment below and update the code to test SaveLinkAttachmentRequest
      //var instance = new CherwellRestApi.SaveLinkAttachmentRequest();
      //expect(instance).to.be.a(CherwellRestApi.SaveLinkAttachmentRequest);
    });
    ...
    it('should have the property uncFilePath (base name: "uncFilePath")', function() {
      // uncomment below and update the code to test the property uncFilePath
      //var instance = new CherwellRestApi.SaveLinkAttachmentRequest();
      //expect(instance).to.be();
    });
