...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.TeamsResponse();
  });
  ...
  describe('TeamsResponse', function() {
    it('should create an instance of TeamsResponse', function() {
      // uncomment below and update the code to test TeamsResponse
      //var instance = new CherwellRestApi.TeamsResponse();
      //expect(instance).to.be.a(CherwellRestApi.TeamsResponse);
    });
