...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.TeamsV2Response();
  });
  ...
  describe('TeamsV2Response', function() {
    it('should create an instance of TeamsV2Response', function() {
      // uncomment below and update the code to test TeamsV2Response
      //var instance = new CherwellRestApi.TeamsV2Response();
      //expect(instance).to.be.a(CherwellRestApi.TeamsV2Response);
    });
