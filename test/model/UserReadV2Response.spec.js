...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.UserReadV2Response();
  });
  ...
  describe('UserReadV2Response', function() {
    it('should create an instance of UserReadV2Response', function() {
      // uncomment below and update the code to test UserReadV2Response
      //var instance = new CherwellRestApi.UserReadV2Response();
      //expect(instance).to.be.a(CherwellRestApi.UserReadV2Response);
    });
