...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.AddUserToTeamResponse();
  });
  ...
  describe('AddUserToTeamResponse', function() {
    it('should create an instance of AddUserToTeamResponse', function() {
      // uncomment below and update the code to test AddUserToTeamResponse
      //var instance = new CherwellRestApi.AddUserToTeamResponse();
      //expect(instance).to.be.a(CherwellRestApi.AddUserToTeamResponse);
    });
