...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.AttachmentsResponse();
  });
  ...
  describe('AttachmentsResponse', function() {
    it('should create an instance of AttachmentsResponse', function() {
      // uncomment below and update the code to test AttachmentsResponse
      //var instance = new CherwellRestApi.AttachmentsResponse();
      //expect(instance).to.be.a(CherwellRestApi.AttachmentsResponse);
    });
