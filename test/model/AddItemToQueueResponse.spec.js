...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.AddItemToQueueResponse();
  });
  ...
  describe('AddItemToQueueResponse', function() {
    it('should create an instance of AddItemToQueueResponse', function() {
      // uncomment below and update the code to test AddItemToQueueResponse
      //var instance = new CherwellRestApi.AddItemToQueueResponse();
      //expect(instance).to.be.a(CherwellRestApi.AddItemToQueueResponse);
    });
