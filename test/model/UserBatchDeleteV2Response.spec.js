...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.UserBatchDeleteV2Response();
  });
  ...
  describe('UserBatchDeleteV2Response', function() {
    it('should create an instance of UserBatchDeleteV2Response', function() {
      // uncomment below and update the code to test UserBatchDeleteV2Response
      //var instance = new CherwellRestApi.UserBatchDeleteV2Response();
      //expect(instance).to.be.a(CherwellRestApi.UserBatchDeleteV2Response);
    });
