...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CherwellRestApi.UserBatchSaveV2Response();
  });
  ...
  describe('UserBatchSaveV2Response', function() {
    it('should create an instance of UserBatchSaveV2Response', function() {
      // uncomment below and update the code to test UserBatchSaveV2Response
      //var instance = new CherwellRestApi.UserBatchSaveV2Response();
      //expect(instance).to.be.a(CherwellRestApi.UserBatchSaveV2Response);
    });
